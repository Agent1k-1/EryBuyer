...
public class BossBarManager {
    ...
    public void createBossBar(Player player) {
        ...
        String raw = plugin.getConfigManager().getConfig().getString("autobuyer-bossbar.autobuyer-bossbar-text", "&fУ вас включён &cавто-скупщик");
        String text = PlaceholderAPIHook.apply(raw, player);
        BarColor color = BarColor.RED;
        try {
            String c = plugin.getConfigManager().getConfig().getString("autobuyer-bossbar.autobuyer-bossbar-color", "RED");
